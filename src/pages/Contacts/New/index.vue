<template>
  <div class="new">
    ...
    <ul class="new-ul">
      <li
        class="new-li"
        v-for="item in friendApplys"
        :key="item.friendId"
        :class="{
          reqError: errorId == item.friendId,
          reqSuccess: successId == item.friendId,
        }"
      >
        <div class="li-left">
          <img :src="item.imgUrl" />
        ...
        <div class="li-right">
          <div class="li-right-btn agree" @click="agree(item.friendId)">
            同意
          </div>
          <div class="li-right-btn reject" @click="reject(item.friendId)">
            拒绝
          </div>
        </div>
      </li>
